...
class DORN(nn.Module):
    """
    Depth-Ordered Residual Network (DORN) baseline for NYU Depth v2.
    Based on original DORN architecture: https://arxiv.org/abs/1806.01260
    """
    ...
    def __init__(self, num_classes=64, pretrained=True):
        ...
        self.register_buffer('bin_centers', torch.linspace(0.1, 10.0, num_classes))
...
def dorn_baseline(pretrained=True):
    return DORN(num_classes=64, pretrained=pretrained)
